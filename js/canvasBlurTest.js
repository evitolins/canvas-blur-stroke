...
var input_preset1 = document.getElementById('preset_1');
var input_preset2 = document.getElementById('preset_2');
var input_preset3 = document.getElementById('preset_3');
...
input_preset1.addEventListener('click', listeners.input_preset1);
input_preset2.addEventListener('click', listeners.input_preset2);
input_preset3.addEventListener('click', listeners.input_preset3);
input_preset4.addEventListener('click', listeners.input_preset4);
input_preset5.addEventListener('click', listeners.input_preset5);
